...
weight = {'wf': tf.Variable(tf.truncated_normal(shape=shape, mean =0, stddev=0.1))}
biases = {'bf': tf.Variable(tf.zeros(nb_classes))}
logits = tf.add(tf.matmul(fc7, weight['wf']), biases['bf'])
